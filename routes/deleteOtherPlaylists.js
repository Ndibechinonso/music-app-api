...
router.post('/', async function (req, res) {
    ...
    try {
        ...
        const deleteOtherPlaylists = await axios.delete(`https://api.deezer.com/user/${id}/playlists?playlist_id=${playlistId}&access_token=${accessToken}`)
        if(deleteOtherPlaylists.data.error){
            console.log(deleteOtherPlaylists.data.error, "deleteOtherPlaylistserror");
