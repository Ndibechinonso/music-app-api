...
router.post('/', async function (req, res) {
    ...
    try {
        ...
        const deleteTrack = await axios.delete(`https://api.deezer.com/playlist/${playlistId}?access_token=${accessToken}`)
        if(deleteTrack.data.error){
            console.log(deleteTrack.data.error, "deleteTrackError");
